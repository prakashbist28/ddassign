...
const EditEmployee = () => {
      ...
      try {
        ...
        const employeeData = response.data.employee;
            ...
            setFormData((prevData) => ({
                ...prevData,
                ...employeeData,
                course: Array.isArray(employeeData.course) ? employeeData.course : [],
        ...
        toast.error('Error fetching employee data', toastOptions);
      }
    };
    fetchEmployee();
  }, [id]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success('Employee updated successfully. Redirecting...', toastOptions);
        setFormData({
          name: '',
          email: '',
          mobile: '',
  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center mt-20 mb-20'>
      <h1 className='font-bold font-ten text-4xl text-red-400'>Update an Employee</h1>
     ...
     <label className='label-custom'>Gender</label>
        ...
        <button className='btn-custom' type="submit">Update Employee</button>
       
      </form>
      {loading && (<div className="flex absolute bg-black flex-col gap-4 md:gap-8 w-full min-h-screen items-center text-center m-auto justify-center">
      <h1 className="font-ten text-[18px] md:text-[24px] font-bold text-red-400"> Please wait... </h1>
      <FadeLoader size={150} color="#f54242" />
      <h1 className="font-ten text-[14px] md:text-[20px] font-bold text-red-400"> Updating Employee Data</h1>
    </div>)}
    </div>
    <ToastContainer />
   </>
